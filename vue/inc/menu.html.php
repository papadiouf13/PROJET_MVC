   ...
   <div class="grandCadre">
       <div class="profil">
           ...
           <div class="modificationAdmin">
               ...
               <a href="<?php echo WEB_ROUTE.'?controller=AdminController&view=list.Admin'?>" class="lienModAmin"> <i class="fa-solid fa-list"></i> </a><a href="<?php echo WEB_ROUTE.'?controller=AdminController&view=list.Admin'?>" class="lienModAmin">  Liste Admin  </a><br><br><br>
